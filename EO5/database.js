...
var descriptions = {
    ...
    "Shaman":   ["Support casters who manage buffs to assist their allies.",
                    "<b>Divine Punisher</b>: Sacrifices buffs as energy to attack, defend and heal.",
                    "<b>Divine Herald</b>: Expands buffs with blessings to safeguard the party."],
...
function reset_list(class_name){
    ...
    if (descriptions[class_name][1] != ""){
        var mastery = document.createElement("ul")
        skill_list.appendChild(mastery)
        var mastery1 = document.createElement("li")
        mastery1.innerHTML = descriptions[class_name][1]
        mastery.appendChild(mastery1)
        var mastery2 = document.createElement("li")
